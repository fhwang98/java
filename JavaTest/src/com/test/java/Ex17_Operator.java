...
public class Ex17_Operator {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(true && true); // 쓸 일 없음
		
		int age = 20;
		
		System.out.println(age > 19 && age < 60);// 순서 ">" -> "<" -> "&&"
		System.out.println();
		...
		/*
			...
			- LValue와 RValue의 자료형은 반드시 동일해야 한다. > 다르면 형변환
			- 대입연산자는 모든 연산자들 중 우선순위가 가장 낮다.
		...
		*/
		...
		/*
			...
			*** 연산자의 위치를 바꿀 수 있다. > 연산자 우선 순위가 달라진다.
			1. ++n: 전위 배치(전치) > 연산자 우선 순위가 가장 높음(소괄호빼고 소괄호는 항상1등)
			2. n++:	후위 배치(후치) > 연산자 우선 순위가 가장 낮음(대입연산자보다 낮음)
...
//		System.out.println();
		...
		//3항 연산자 > if문 사용 /간단한건 3항연산자 사용 권장
