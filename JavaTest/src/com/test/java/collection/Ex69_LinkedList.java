...
//		//ArrayList Shift 발생, LinkedList Shift발생 X
...
//		System.out.println("[중간 데이터 삭제하기, Remove]");
//		
//		//ArrayList
//		begin = System.currentTimeMillis();
//		
...
//		
//		
		//순차적으로 데이터 삭제하기 > Shift 발생X
		System.out.println("[순차적으로 데이터 삭제하기, Remove]");
		
		//ArrayList
		begin = System.currentTimeMillis();
		
		for (int i = list1.size() - 1; i >= 0; i--) {
			list1.remove(i); // 끝 > 시작 순차적으로 삭제
		}
