...
public class Ex36_Class {
	...
	public static void main(String[] args) {
		...
		/*
			...
			5. 인터페이스
				- 캡슐화 된 내부와 외부 간의 최소한의 연결을 가능하게 하는 통로 역할
				...
				객체 =  데이터 + 행동의 집합
				리모콘 = 데이터(회색, 100g, 8cmx17cm ..) + 행동(전원On, 전원Off, 배터리를 넣는다, 배터리를 뺀다 ...)
		...
		*/
		...
		//- 배열 단점 > 요소 간의 성질을 구분하기 힘들다. > 첨자 사용
		//	> 첨자는 의미를 가지지 못한다.
		//	> 몇번째 방에 어떤 데이터를 넣었는지 관리 힘들다.
		//	> 배열은 같은 타입의 같은 성질의 데이터 집합
		...
		//우리집
		//p1 == 객체변수, 객체 참조 변수
		// 만들어진 객체(인스턴스)의 주소를 기억
		Point p1 = new Point(); //new Point() == 객체 생성 (Heap에 생성)
		p1.x = 100; //객체 (멤버) 변수
		p1.y = 200; //객체 (멤버) 변수
